...
def test_sun_initial_properties():
    # 測試以太陽 (1.0 M☉) 為基準的計算
    props = StarPhysicsCalculator.compute_initial_properties(mass=1.0, metallicity=1.0, rotation=0.0)
...
def test_massive_star_evolution_stage():
    ...
    stage, stage_name, l, r = StarPhysicsCalculator.calculate_evolution_state(mass=20.0, l0=1000, r0=10, age_frac=1.2)
